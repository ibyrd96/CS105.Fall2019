...
public class Lab9b {
	...
	public static int addItems(Scanner sIn, ArrayList<String> shoppingList) {
		...
		while (true) {// get numbers from user or enter key
			...
			if (answer.indexOf(":")<0)
				...
				shoppingList.add(answer.substring(0,cIndex).trim()+":"+answer.substring(cIndex+1).trim());
				System.out.println(
	 ...
	 */
	public static void showItems(ArrayList<String> shoppingList, String listTitle) {
		System.out.println("The Shopping List contains the following items");
		System.out.printf("%s\n", "--------------------------");
		System.out.printf("\t%s\n",listTitle);
		System.out.printf("%s\n", "--------------------------");
		for (String i:shoppingList) 
			System.out.printf("\t%s\t%s\n", i.substring(0,i.indexOf(":")),i.substring(i.indexOf(":")+1));
		System.out.printf("%s\n", "--------------------------");
